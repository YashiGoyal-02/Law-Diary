...
<body>
    ...
    <div class="container" style="display:flex">
        <div class="col col-sm-6" style="flex:1">
            <form id="citationForm" action="./citationCase.php" method="post">
            ...
            <div style="float: center;">
                <center>
                    <form action="../home.php" style="display: inline;">
                        <input class="button" type="submit" value="Go to Home Page">
                    </form>
                </center>
            </div>
        </div>

        <div class="col col-sm-6" style="flex:0.5; margin-left:10px">
            <?php
