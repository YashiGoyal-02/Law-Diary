...
<body>
    ...
    <div class="container" style="display:flex">
        <div class="col" style="flex:1">
            <?php
            $sqlCit = "select * from citations ORDER BY idCit DESC LIMIT 1";
            ...
            $sql = "insert into citations(idCit, userid, citation, remarks) values ($idCit, $userId, '$citation', '$remarks')";
            ...
            ?>
                <div class="button" style="float: center; width: 30%">
                    <center>
                        <form action="./addGeneral.php" method="post">
