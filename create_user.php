...
<body>
    ...
    <?php
    if ($name && $phn && $username && $password) {
        $sql = "insert into userdetails (id, name, phn, username, password, paymentMode) values ('$id', '$name', '$phn', '$username', '$password', '$mode')";
    ...
    <br><br><br>
    <center>
        <h1 style="color: grey">New User Successfully added!!</h1>
        <h1>Your UserId : <?php echo $last_id ?><br>Your Username : <?php echo $username ?></h1>
        <?php
