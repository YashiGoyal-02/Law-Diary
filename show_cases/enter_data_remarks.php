...
<body>
    ...
    ?>
    <center>
        <h4>Enter additional information-</h4><br>
        <div class="form1">
            <form action="remarks.php?varname=<?php echo $id1 ?>" method="post">
                <textarea type="text" name="data" rows="6" cols="70" required></textarea><br><br>

                <div style="float: center;">

                    <form action="remarks.php" method="post">
                        <button class="button" name="idid" style="float: center;" value=<?php echo htmlspecialchars($id1); ?>>Add Remarks</button>
                    </form>
                    <input class="button" type="reset" style="float: center; display: inline;">
