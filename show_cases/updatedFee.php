...
<body>
    ...
    // if(isset($_POST['feePaid'])) {
    $fee = $_GET['feePaid'];
    $dateExtra = $_GET['dateExtr'];
    $updateSql = "update casedate set feePaid=$fee where 
        userid=$userId and caseid=$caseId and date='$dateExtra';";
                ...
                <div class="row">
                    <div class="col-sm-4">
                        ...
                        <div style="float: center;">
                            ...
                            <center>
                                <form action="../citations/addToCase.php" style="display: inline" method="post">
                                    <input type="hidden" value=<?php echo $caseId ?> name="caseid">
                                    <input type="submit" class="button" value="Add Citations">
                                </form>
                            </center>
                            ...
                            <center>
                                <form action="../show_cases/case_view.php" style="display: inline">
                                    <input type="submit" class="button" value="View Case List">
                                </form>
                            </center>
                                    ...
                                    <center>
                                        ...
                                        <?php
                                            if (isset($_POST['feePaid'])) {
                                                $fee = $_POST['feePaid'];
                                                $updateSql = "update casedate set feePaid=$fee where 
                                        userid=$userId and caseid=$caseId and date='$dateExtr';";
                                                if ($mysqli->query($updateSql) === FALSE) {
                                                    echo "Error: " . $updateSql . "<br>" . $mysqli->error;
                                                }
                                            }
