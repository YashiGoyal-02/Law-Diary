...
<body>
    ...
    $todayDateNow = $_POST['dateToday'];
    // $todayDate=date_create('$dateToday');
    $prevSql = "SELECT DATE_SUB('$todayDateNow', INTERVAL 1 DAY) as prevdate;";
    $res = $mysqli->query($prevSql);
    $rowPrev1 = $res->fetch_assoc();
    $todayDate = $rowPrev1['prevdate'];
