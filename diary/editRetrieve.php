...
<body>
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            if ($caseNum == $caseid) {
            ?>
                <form action="./saveRetrieve.php" method="post" id="saveChanges">
                    <td>
                        <center>
                            <?php
                    ...
                    ?>
                    <input type="hidden" name="currentNext" value="<?php echo $nextRetDate ?>">
                    <td>
                        <center>
                ...
                <td style="font-size:15px">
                    <center><a href="../show_cases/casedetails_caseview.php?varname=<?php echo $caseNum ?>">
                            ...
                            $stages = array(
                                ...
                                'Non Bailable Warrant', 'Plaintiff Evidence', 'Exparte Evidence', 'Prosecution Evidence', 'Defendant Evidence', 'Respondent Evidence',
                                'Munadi', 'Notice', 'Order', 'Reply', 'Replication', 'Rebuttal', 'Publication', 'Written Statement', '313 Cr.P.C.', 'L.Rs',
                                'No instruction pleaded', 'To file Affidavit', 'Lower Court Record', 'Correct Address', 'To give document'
                            );
        ...
        <?php
            if ($caseNum == $caseid) { ?>
            <td><button style="font-size:15px" class="button" id="submit" name="saveButton" onclick="document.getElementById('saveChanges').submit()">
                    <i class="fas fa-save"></i> Save</button></td>
        <?php
            } ?>
        </tr>
