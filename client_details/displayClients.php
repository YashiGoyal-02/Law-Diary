...
<body>
    ...
    $sql = "select * from clients where clientName='$clName'";
    ...
    echo "</table></center>";
    ?>
    <!-- <br><br><center><a name='home' href="../home.php" style='font-size:17px; margin-left:11%'>Go to Home Page</a></center> -->
    ...
    <center>
        <div style="float: center;">
            ...
            <form action="./searchClient.php" method="post">
                <button style="float: center;" class="button">Find another Client</button>
            </form>
