...
<body>
                    ...
                    <div class="navbar-nav mr-auto">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <a href="../client_details/searchClient.php" class="dropdown-item active">Search Client</a>
    ...
    <div class="form1">
        <form action="displayClients.php" method="post">
            ...
            <div style="float: center;" class="col-md-4 col-sm-2 col-lg-2">
                <center>
                    <form action="displayClients.php" method="post">
                        <button class="button" name="idid" style="float: center;">Find Clients</button>
                    </form>
                    <input type="reset" class="button" style="float: center">
